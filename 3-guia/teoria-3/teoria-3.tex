\begin{enumerate}[label=\tiny\purple{\faIcon{calculator}}]
  ...
  \item \textit{Grafos Planos:}
        ...
        \parrafoDestacado {
          \it
          Si dos grafos $G_1$ y $G_2$ con matrices de adyacencia $A_1$ y $A_2$ respectivamente,
          tienen $\columna(A_1) = \columna(A_2)$, entonces son \underline{isomorfos}.
        }
        $\columna(A)$ es el espacio columna de la matriz $A$. Es como decir que las matrices de adyacencias son una permutación.
        ...
        \begin{minipage}{0.3\textwidth}
          Las funciones $f\ytext g$ biyectivas que los relacionan:
          $$
            \llave{l}{
              f(1) = y\\
              f(2) = x\\
